...
CREATE TABLE `tuning_algorithm` (
  `id` int(10) unsigned NOT NULL COMMENT 'Auto increment unique id',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='this table identifies algo to be used';

INSERT INTO tuning_algorithm VALUES (0, 'PIG', 'PSO', '1', 'RESOURCE', current_timestamp(0), current_timestamp(0));
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT 'represents hadoop parameters to be optimized for each algo';

INSERT INTO `tuning_parameter` VALUES (0,'mapreduce.task.io.sort.mb',1,100,50,1920,50, 0, current_timestamp(0), current_timestamp(0));
INSERT INTO `tuning_parameter` VALUES (0,'mapreduce.map.memory.mb',1,2048,1536,8192,128, 0, current_timestamp(0), current_timestamp(0));
INSERT INTO `tuning_parameter` VALUES (0,'mapreduce.task.io.sort.factor',1,10,10,150,10 ,0, current_timestamp(0), current_timestamp(0));
INSERT INTO `tuning_parameter` VALUES (0,'mapreduce.map.sort.spill.percent',1,0.8,0.6,0.9,0.1, 0, current_timestamp(0), current_timestamp(0));
INSERT INTO `tuning_parameter` VALUES (0,'mapreduce.reduce.memory.mb',1,2048,1536,8192,128, 0, current_timestamp(0), current_timestamp(0));
INSERT INTO `tuning_parameter` VALUES (0,'pig.maxCombinedSplitSize',1,536870912,536870912,536870912,128, 0, current_timestamp(0), current_timestamp(0));
INSERT INTO `tuning_parameter` VALUES (0,'mapreduce.reduce.java.opts',1,1536,1152,6144,128, 1, current_timestamp(0), current_timestamp(0));
INSERT INTO `tuning_parameter` VALUES (0,'mapreduce.map.java.opts',1,1536,1152,6144,128, 1, current_timestamp(0), current_timestamp(0));
INSERT INTO `tuning_parameter` VALUES (0,'mapreduce.input.fileinputformat.split.maxsize',1,536870912,536870912,536870912,128, 1, current_timestamp(0), current_timestamp(0));
...
) ENGINE=InnoDB AUTO_INCREMENT=10000 DEFAULT CHARSET=latin1 COMMENT 'represent flow of the job';
...
CREATE TABLE `job_definition` (
  ...
  `job_name` varchar(1000) DEFAULT NULL COMMENT 'name of the job',
  `job_def_url` varchar(1000) NOT NULL COMMENT 'job definition URL from scheduler like azkaban, oozie, appworx etc',
...
) ENGINE=InnoDB AUTO_INCREMENT=100000 DEFAULT CHARSET=latin1 COMMENT 'represent the job to be optimized';
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT 'represent the job to be optimized';
...
CREATE TABLE `flow_execution` (
  ...
  `flow_definition_id` int(10) unsigned NOT NULL 'foreign key from flow_definition table',
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=803 DEFAULT CHARSET=latin1 COMMENT 'represent one execution of a flow';
